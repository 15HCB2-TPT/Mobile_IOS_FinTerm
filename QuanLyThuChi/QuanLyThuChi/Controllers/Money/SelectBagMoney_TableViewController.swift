//
//  SelectBagMoney_TableViewController.swift
//  QuanLyThuChi
//
...
class SelectBagMoney_TableViewController: UITableViewController {
    
//    @IBAction func backClick(_ sender: Any) {
//        self.dismiss(animated: true, completion: nil)
//    }

    var bagMoneys = Database.select(entityName: "BagMoney", predicater: nil, sorter: nil) as! [BagMoney]
