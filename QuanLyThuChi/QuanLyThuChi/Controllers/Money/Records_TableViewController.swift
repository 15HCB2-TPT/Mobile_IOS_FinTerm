//
//  Records_TableViewController.swift
//  QuanLyThuChi
//
...
class Records_TableViewController: UITableViewController {
    
    //var moneys = Database.select(entityName: "Money", predicater: NSPredicate(format: "(transfer == nil) OR (transfer != nil AND money_category.category_type.name == 'Chi')"), sorter: [NSSortDescriptor(key: "date", ascending: false)]) as! [Money]
